...
With that configuration, the results are very simmilar, except that the \pkg{Zebende} pure \proglang{Python} implementation ended in the third position, performing better than the \pkg{DCCA-Python} (4th) and the \pkg{DCCA-R-Java} (5th) packages. 
