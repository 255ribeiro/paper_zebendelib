...
The codes used for testing are available in \url{replace}, as jupyter noteooks, in  and can easily be tested in Google colab environment. The basic version is available in \pkg{Zebende} version $0.1.91$ and the optimized implementation in version $0.2.0$ of the package.
